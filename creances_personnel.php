<?php session_start();
$cle_actuelle="creances_personnel";
$reference="php/";
...
if(isset($_SESSION["connecter"])&&isset($_SESSION["type"])){
	if($_SESSION["connecter"]){
		...
		<head>	
			<title>Créances personnelles</title>
			<?php include("php/header.php");?>
			<script>
			var Cle_actuelle='<?php echo $cle_actuelle; ?>';
			<?php include("php/variables.php") ?>;
			var Champs_omis=["id"];Champs_omis_selection=[""];
			var tableau_reglage=[];
			var tableau_reste=[];
			var Test_reglage=0;
			var Montant=0;
	...
	<body>
		...
		<div id="conteneur" class="page_creances">
			<?php $cle_actuelle="creances_personnel"; 
			include("php/entete.php"); ?>
			<div id="formulaire_ajout">
				<?php require_once('ajouter_creance.php'); ?>
			</div>
			<div id="ouvrir_formulaire" title="<?php echo MESSAGE_AJOUTER_CREANCE_PERSONELLE;?>" title1="<?php echo MESSAGE_AJOUTER_CREANCE_PERSONELLE;?>" title2="<?php echo MESSAGE_FERMER_FORMULAIRE;?>">
				Ajouter créance
			</div>
			...
			<div class="conteneur elements">	
				...
				<ul id="type_creance">
					<li id="entreprise" ><a href="creances.php">Entreprise</a></li>
