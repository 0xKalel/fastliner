			...
			$.post("ajax/chargement/charger_elements.php",param,function(resultat){
				...
				for(var i=0; i<resultat.length; i++) {
					chauffeurs+="<tr  onClick='voir_feuille("+resultat[i].id+")'>";
						...
						if( filtres_cache[j]=="avance")				avance="<td style='display: none' id='avance'> "+resultat[i].avance+"</td>";
						if( filtres_cache[j]=="date")			date="<td style='display: none' id='matricule'> "+resultat[i].date+"</td>"
								}
						}
